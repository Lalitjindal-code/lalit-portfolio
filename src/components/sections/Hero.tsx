...
export const Hero = () => {
  return (
    <section id="home" className="relative h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 premium-grid opacity-[0.15] dark:opacity-[0.15] mix-blend-multiply dark:mix-blend-screen pointer-events-none" />

      {/* Abstract SVG Mesh */}
      <div className="absolute inset-0 z-0 pointer-events-none opacity-5 dark:opacity-20 mix-blend-multiply dark:mix-blend-screen flex items-center justify-center">
        <motion.svg
      ...
      <div className="container mx-auto px-5 sm:px-6 relative z-10 flex flex-col items-center text-center pointer-events-none">
        ...
        >
          ...
          <div className="overflow-hidden relative">
            <motion.h1
              ...
              className="text-transparent bg-clip-text bg-gradient-to-r from-foreground via-foreground/90 to-muted-foreground"
            >
              Excellence.
            </motion.h1>
          </div>
        ...
        >
          <MagneticWrapper strength={0.4}>
            <a href="#projects" className="group relative inline-flex items-center gap-3 sm:gap-4 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full bg-foreground/5 border border-foreground/20 hover:bg-foreground/10 hover:border-foreground/40 transition-all duration-500 backdrop-blur-md active:scale-95">
